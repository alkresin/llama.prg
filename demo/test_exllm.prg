...
FUNCTION Main
   ...
   INIT WINDOW oMain MAIN TITLE "Llama.prg" AT 200,0 SIZE 800,550 FONT oFontMain
...
STATIC FUNCTION AddEdit()
   ...
   @ 4, HPANE_H + 4 + oEdit1:nHeight + HSPLIT_H HCEDIT oEdit2 OF oMain ;
      SIZE oBoa:nWidth, nWinHeight - HPANE_H - 12 - oEdit1:nHeight - HSPLIT_H - 4 BACKCOLOR CLR_LGRAY1 ;
...
STATIC FUNCTION LoadModel()
   ...
   INIT DIALOG oDlg TITLE "Load model" AT 0,0 SIZE 500, 440
   ...
   NEXT
   @ 20, 16 DRAWN COMBO oCombo1 ITEMS am SIZE 460, 30 BACKCOLOR CLR_WHITE INIT 1

   @ 10, 100 DRAWN SIZE 140, 28 COLOR CLR_WHITE BACKCOLOR CLR_DGRAYA TEXT 'n_ctx'
   @ 150,100 DRAWN EDIT oEdit1 CAPTION n_ctx PICTURE "9999" SIZE 80, 28

   @ 240,100 DRAWN SIZE 140, 28 COLOR CLR_WHITE BACKCOLOR CLR_DGRAYA TEXT 'n_predict'
   @ 400,100 DRAWN EDIT oEdit2 CAPTION n_predict PICTURE "9999" SIZE 80, 28

   @ 10, 180 DRAWN SIZE 140, 28 COLOR CLR_WHITE BACKCOLOR CLR_DGRAYA TEXT 'temp'
   @ 150,180 DRAWN EDIT oEdit5 CAPTION temp PICTURE "999.9" SIZE 80, 28

   @ 240, 180 DRAWN SIZE 140, 28 COLOR CLR_WHITE BACKCOLOR CLR_DGRAYA TEXT 'repeat_penalty'
   @ 400,180 DRAWN EDIT oEdit6 CAPTION penalty_r PICTURE "99.9" SIZE 80, 28

   @ 10, 220 DRAWN SIZE 140, 28 COLOR CLR_WHITE BACKCOLOR CLR_DGRAYA TEXT 'top_k'
   @ 150,220 DRAWN EDIT oEdit7 CAPTION top_k PICTURE "999" SIZE 80, 28

   @ 240, 220 DRAWN SIZE 140, 28 COLOR CLR_WHITE BACKCOLOR CLR_DGRAYA TEXT 'top_p'
   @ 400,220 DRAWN EDIT oEdit8 CAPTION top_p PICTURE "99.99" SIZE 80, 28

   @ 10, 260 DRAWN SIZE 140, 28 COLOR CLR_WHITE BACKCOLOR CLR_DGRAYA TEXT 'min_p'
   @ 150,260 DRAWN EDIT oEdit9 CAPTION min_p PICTURE "9.99" SIZE 80, 28

   @ 240, 260 DRAWN SIZE 140, 28 COLOR CLR_WHITE BACKCOLOR CLR_DGRAYA TEXT 'repeat_last'
   @ 400,260 DRAWN EDIT oEdit10 CAPTION penalty_l PICTURE "999" SIZE 80, 28

   @ 40, oDlg:nHeight - 56 DRAWN SIZE 100, 40 COLOR CLR_WHITE HSTYLES aStyles TEXT 'Ok' ;
      ON CLICK bOk
   @ 310, oDlg:nHeight - 56 DRAWN SIZE 100, 40 COLOR CLR_WHITE HSTYLES aStyles TEXT 'Cancel' ;
